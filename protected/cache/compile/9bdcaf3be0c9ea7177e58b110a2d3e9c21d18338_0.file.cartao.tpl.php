<?php
/* Smarty version 3.1.30, created on 2016-09-21 09:38:31
  from "C:\wamp\www\structure\site\protected\mail\cartao.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_57e27f47cf92e1_30677219',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9bdcaf3be0c9ea7177e58b110a2d3e9c21d18338' => 
    array (
      0 => 'C:\\wamp\\www\\structure\\site\\protected\\mail\\cartao.tpl',
      1 => 1474460519,
      2 => 'file',
    ),
  ),
...
function content_57e27f47cf92e1_30677219 (Smarty_Internal_Template $_smarty_tpl) {
?>
                                                                                                                ...
                                                                                                                <tbody><tr style="vertical-align: top">
                                                                                                                        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;padding-top: 5px;padding-right: 10px;padding-bottom: 5px;padding-left: 10px">
                                                                                                                            <div style="color:#777777;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">            
                                                                                                                                <div style="font-size:12px;line-height:14px;color:#777777;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 16px; line-height: 19px;">Voc&#234; contratou o Plano <?php echo $_smarty_tpl->tpl_vars['plano']->value;?>
&nbsp;</span></p></div>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                            ...
                                                                                                            <table style="border-spacing: 0;border-collapse: collapse;vertical-align: top" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                <tbody><tr style="vertical-align: top">
                                                                                                                        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;padding-top: 15px;padding-right: 10px;padding-bottom: 10px;padding-left: 10px">
                                                                                                                            <div style="color:#626262;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">            
                                                                                                                                <div style="font-size:12px;line-height:14px;color:#626262;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 14px"><span style="font-size: 14px; line-height: 16px;">Status da compra:
                                                                                                                                            <?php if ($_smarty_tpl->tpl_vars['status']->value == 1) {?>
                                                                                                                                                <span style="color: #999; font-size: 14px; line-height: 16px;"> Aguardando Pagamento </span>
                                                                                                                                            <?php }?>                
                                                                                                                                            <?php if ($_smarty_tpl->tpl_vars['status']->value == 2) {?>
                                                                                                                                                <span style="color: #999; font-size: 14px; line-height: 16px;"> Em análise</span>
                                                                                                                                            <?php }?>                
                                                                                                                                            <?php if ($_smarty_tpl->tpl_vars['status']->value == 3) {?>
                                                                                                                                                <span style="color: rgb(51, 153, 102); font-size: 14px; line-height: 16px;"> Confirmado</span>
                                                                                                                                            <?php }?>                
                                                                                                                                            <?php if ($_smarty_tpl->tpl_vars['status']->value == 4) {?>
                                                                                                                                                <span style="color: rgb(51, 153, 102); font-size: 14px; line-height: 16px;"> Confirmado</span>
                                                                                                                                            <?php }?>                
                                                                                                                                            <?php if ($_smarty_tpl->tpl_vars['status']->value == 5) {?>
                                                                                                                                                <span style="color: #cc9900; font-size: 14px; line-height: 16px;"> Em disputa</span>
                                                                                                                                            <?php }?>                
                                                                                                                                            <?php if ($_smarty_tpl->tpl_vars['status']->value == 6) {?>
                                                                                                                                                <span style="color: #F00; font-size: 14px; line-height: 16px;"> Devolvida</span>
                                                                                                                                            <?php }?>                
                                                                                                                                            <?php if ($_smarty_tpl->tpl_vars['status']->value == 7) {?>
                                                                                                                                                <span style="color: #F00; font-size: 14px; line-height: 16px;"> Cancelada</span>
                                                                                                                                            <?php }?>                
                                                                                                                                        </span><br></p><p style="margin: 0;font-size: 12px;line-height: 14px">&nbsp;<br></p><p style="margin: 0;font-size: 12px;line-height: 14px">Seu servidor est&#225; sendo configurado. Breve entraremos em contato</p></div>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </tbody></table>
                                                                                                                                            ...
                                                                                                                                            <!--[if !mso]><!- - --><div style="display: inline-block;
                                                                                                                                                ...
                                                                                                                                                <table style="border-spacing: 0;border-collapse: collapse;vertical-align: top;height: 0" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                                                    <tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;border-radius: 5px;                   -webkit-border-radius: 5px;                   -moz-border-radius: 5px;                  color: #ffffff;                  background-color: #C7702E;                  padding-top: 5px;                   padding-right: 20px;                  padding-bottom: 5px;                  padding-left: 20px;                  font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align: center" valign="middle"><!--<![endif]-->
                                                                                                                                                                <a style="display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;background-color: #C7702E;color: #ffffff" href="<?php echo $_smarty_tpl->tpl_vars['SITE_URL']->value;?>
contato" target="_blank">
                                                                                                                                                                    <span style="font-size:16px;line-height:32px;">Contato</span>
                                                                                                                                                                </a>
